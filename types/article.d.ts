 ...
 * 发帖信息
 */
declare interface IArticlePost {
    /**
     * 帖子标题
     */
    articleTitle: string;
 ...
 * 文章详情
 */
declare interface IArticleDetail {
    /**
     * 是否在列表展示
     */
 ...
 * 文章评论
 */
declare interface IArticleComment {
    /**
     * 是否优评
     */
    commentNice: boolean;
 ...
 * 文章列表
 */
declare interface IArticleList {
    /**
     * 文章列表
     */
...
declare interface ICommentPost {
    /**
     * 文章 Id
     */
    articleId: string;
